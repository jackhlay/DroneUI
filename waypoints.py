...
#send local frame coordinates and have drone fly over that spot.
...
#send global gps coordinates and altitude, and have drone fly over that spot. 
...
send_waypoint_global(drone_connection, -35.3628219 * 1e7, 149.1641168 * 1e7, 15) #send drone to a random gps coordinate. each coordinate is multiplied by 10,000,000 to mach mavlink gps format
